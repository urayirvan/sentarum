...
class Custom3Export extends DefaultValueBinder implements WithCustomValueBinder, FromQuery, WithMapping, WithHeadings
{
    /**
    ...
    */
    ...
    //use Exportable;
    //protected $kec;
    public function __construct($bank,$kota,$kec,$desa) {
        $this->bank_id = $bank;
